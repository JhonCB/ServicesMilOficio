...
namespace SwaggerUI.APIRest.Controllers
{
    ...
    /// <summary>  
    /// ListarServicioCalificacionController  
    /// </summary> 
    public class ListarServicioCalificacionController : ApiController
    {
        /// <summary>  
        /// getListarServicioCalificacion
        /// </summary>  
        public ResponseServicio getListarServicioCalificacion()
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("[LISTAR_SERVICIO_CALIFICACION]", con);
