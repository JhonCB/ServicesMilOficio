...
{
    /**
     * SE ENCARGA DE LISTAR TODOS LAS OFERTAS RECIEN PUBLICADAS O MÁS RECIENTES
     **/

    /// <summary>  
    /// ListarServicioRecienteController  
    /// </summary> 
    public class ListarServicioRecienteController : ApiController
    {
        /// <summary>  
        /// getListarServicioReciente
        /// </summary>  
        public ResponseServicio getListarServicioReciente()
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("LISTAR_SERVICIO_RECIENTE", con);
