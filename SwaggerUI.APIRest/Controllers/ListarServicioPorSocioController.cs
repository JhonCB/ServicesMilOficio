...
{
    /**
     * SE ENCARGA DE LISTAR TODOS LAS OFERTAS CON MEJOR CALIFICACION
     **/

    /// <summary>  
    /// ListarServicioXSocioController  
    /// </summary> 
    public class ListarServicioPorSocioController : ApiController
    {
        /// <summary>  
        /// getListarServicioXSocio
        /// </summary>  
        public ResponseServicio getListarServicioXSocio(int codSocio)
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("LISTAR_SERVICIO_X_SOCIO", con);
                ...
                while (dr.Read())
                {
                    ...
                    response.desResultado = "Lista de Servicios por Socio";
